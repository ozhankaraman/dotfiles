...
export PATH=/opt/homebrew/bin:/opt/homebrew/sbin:$HOME/.krew/bin:$HOME/.bin:$HOME/.local/bin:/opt/homebrew/opt/gnu-sed/libexec/gnubin:/opt/homebrew/opt/gnu-tar/libexec/gnubin:/opt/homebrew/opt/gnu-indent/libexec/gnubin:$HOME/.arkade/bin:$HOME/.bin:$PATH
